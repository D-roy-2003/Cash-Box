  ...
  async createTriggers(conn) {
    ...
    await this.executeQuery(`
      ...
      BEGIN
        ...
        -- Calculate subtotal
        SET item_subtotal = NEW.price * NEW.quantity;
        
        -- Use the tax_amount directly from the item
        SET item_tax = NEW.tax_amount;
    ...
    await this.executeQuery(`
      ...
      BEGIN
        ...
        SET old_subtotal = OLD.price * OLD.quantity;
        SET new_subtotal = NEW.price * NEW.quantity;
        
        -- Use the tax amounts directly
        SET old_tax = OLD.tax_amount;
        SET new_tax = NEW.tax_amount;
    ...
    await this.executeQuery(`
      ...
      BEGIN
        ...
        -- Calculate subtotal
        SET item_subtotal = OLD.price * OLD.quantity;
        
        -- Update receipt totals by setting to 0 since this is the last item
        UPDATE receipts
        SET 
          subtotal = 0,
          total_tax = 0,
