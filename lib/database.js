    ...
    try {
      ...
      await this.executeQuery(`
        CREATE TABLE IF NOT EXISTS users (
          ...
          store_address TEXT,
          store_contact VARCHAR(20) NOT NULL UNIQUE,
          store_country_code VARCHAR(10) DEFAULT '+91',
          gst_number VARCHAR(15),
          profile_complete BOOLEAN DEFAULT FALSE,
          created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
          updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
          INDEX idx_users_store_contact (store_contact),
...
// Skip database initialization during build time and in production builds
// Disabled auto-initialization to prevent build-time database connections
